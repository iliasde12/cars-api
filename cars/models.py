...
class CarsFilms(models.Model):
    ...
    CarsTrailer = models.FileField(upload_to='staticfiles/Trailer/')
    CarsFilm_Afbeelding = models.FileField(upload_to='staticfiles/film/Afbeelding/' , null=True)
...
class CarsPersonages(models.Model):
    ...
    CarsPersonnage_Afbeelding = models.FileField(upload_to='staticfiles/personnage/Afbeelding/',null=True)
...
class muziek(models.Model):
    ...
    MuziekAfbeelding = models.FileField(upload_to='staticfiles/muziek/afbeelding/',null=True)
    MuziekBestand = models.FileField(upload_to='staticfiles/muziek/muziek/',null=True)
...
class muziekAfbeelding(models.Model):
    ...
    CarsAfbeeldingAlbum =  models.FileField(upload_to='staticfiles/muziek/afbeelding/cover/',null=True) 
...
class games(models.Model):
    ...
    gameAfbeelding = models.FileField(upload_to='staticfiles/games/afbeelding/',null=True)
